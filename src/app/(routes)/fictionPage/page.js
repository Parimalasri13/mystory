  ...
  return (
    ...
    <div style={{  alignItems: 'center' }}>
        ...
        <div className="mb-6 lg:mr-6 text-center justify-center">
                ...
                <p >Once upon a time, in a quaint little village nestled between rolling hills and whispering forests, there lived a curious young girl named Elara. She had eyes as bright as the morning sun and a heart as wild as the meadows that surrounded her home.
